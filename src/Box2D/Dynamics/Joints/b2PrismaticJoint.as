package Box2D.Dynamics.Joints
{
    ...
    public class b2PrismaticJoint extends b2Joint
    {
        ...
        override function SolveVelocityConstraints(param1:b2TimeStep) : void
        {
            ...
            var _loc_19:b2Vec3 = null;
            var _loc_20:b2Vec3 = null;
            ...
            {
                _loc_14 = m_axis.x * (_loc_6.x - _loc_4.x) + m_axis.y * (_loc_6.y - _loc_4.y) + m_a2 * _loc_7 - m_a1 * _loc_5;
                _loc_15 = m_motorMass * (m_motorSpeed - _loc_14);
                _loc_16 = m_motorImpulse;
                _loc_17 = param1.dt * m_maxMotorForce;
                m_motorImpulse = b2Math.Clamp(m_motorImpulse + _loc_15, -_loc_17, _loc_17);
                _loc_15 = m_motorImpulse - _loc_16;
                _loc_8 = _loc_15 * m_axis.x;
                _loc_9 = _loc_15 * m_axis.y;
                _loc_10 = _loc_15 * m_a1;
                _loc_11 = _loc_15 * m_a2;
            ...
            {
                _loc_18 = m_axis.x * (_loc_6.x - _loc_4.x) + m_axis.y * (_loc_6.y - _loc_4.y) + m_a2 * _loc_7 - m_a1 * _loc_5;
                _loc_19 = m_impulse.Copy();
                _loc_20 = m_K.Solve33(new b2Vec3(), -_loc_12, -_loc_13, -_loc_18);
                m_impulse.Add(_loc_20);
                ...
                _loc_21 = -_loc_12 - (m_impulse.z - _loc_19.z) * m_K.col3.x;
                _loc_22 = -_loc_13 - (m_impulse.z - _loc_19.z) * m_K.col3.y;
                _loc_23 = m_K.Solve22(new b2Vec2(), _loc_21, _loc_22);
                m_K.Solve22(new b2Vec2(), _loc_21, _loc_22).x = _loc_23.x + _loc_19.x;
                _loc_23.y = _loc_23.y + _loc_19.y;
                m_impulse.x = _loc_23.x;
                m_impulse.y = _loc_23.y;
                _loc_20.x = m_impulse.x - _loc_19.x;
                _loc_20.y = m_impulse.y - _loc_19.y;
                _loc_20.z = m_impulse.z - _loc_19.z;
                _loc_8 = _loc_20.x * m_perp.x + _loc_20.z * m_axis.x;
                _loc_9 = _loc_20.x * m_perp.y + _loc_20.z * m_axis.y;
                _loc_10 = _loc_20.x * m_s1 + _loc_20.y + _loc_20.z * m_a1;
                _loc_11 = _loc_20.x * m_s2 + _loc_20.y + _loc_20.z * m_a2;
                _loc_4.x = _loc_4.x - m_invMassA * _loc_8;
                _loc_4.y = _loc_4.y - m_invMassA * _loc_9;
                _loc_5 = _loc_5 - m_invIA * _loc_10;
                _loc_6.x = _loc_6.x + m_invMassB * _loc_8;
            ...
            {
                _loc_24 = m_K.Solve22(new b2Vec2(), -_loc_12, -_loc_13);
                m_impulse.x = m_impulse.x + _loc_24.x;
                m_impulse.y = m_impulse.y + _loc_24.y;
                _loc_8 = _loc_24.x * m_perp.x;
                _loc_9 = _loc_24.x * m_perp.y;
                _loc_10 = _loc_24.x * m_s1 + _loc_24.y;
                _loc_11 = _loc_24.x * m_s2 + _loc_24.y;
                _loc_4.x = _loc_4.x - m_invMassA * _loc_8;
                _loc_4.y = _loc_4.y - m_invMassA * _loc_9;
                _loc_5 = _loc_5 - m_invIA * _loc_10;
                _loc_6.x = _loc_6.x + m_invMassB * _loc_8;
        ...
        override function SolvePositionConstraints(param1:Number) : Boolean
        {
            ...
            if (m_enableLimit)
            {
                ...
                _loc_35 = m_axis.x * _loc_26 + m_axis.y * _loc_27;
                if (b2Math.Abs(m_upperTranslation - m_lowerTranslation) < 2 * b2Settings.b2_linearSlop)
                {
                    _loc_19 = b2Math.Clamp(_loc_35, -b2Settings.b2_maxLinearCorrection, b2Settings.b2_maxLinearCorrection);
                    _loc_16 = b2Math.Abs(_loc_35);
                    _loc_18 = true;
                }
                else if (_loc_35 <= m_lowerTranslation)
                {
                    _loc_19 = b2Math.Clamp(_loc_35 - m_lowerTranslation + b2Settings.b2_linearSlop, -b2Settings.b2_maxLinearCorrection, 0);
                    _loc_16 = m_lowerTranslation - _loc_35;
                    _loc_18 = true;
                }
                else if (_loc_35 >= m_upperTranslation)
                {
                    _loc_19 = b2Math.Clamp(_loc_35 - m_upperTranslation + b2Settings.b2_linearSlop, 0, b2Settings.b2_maxLinearCorrection);
                    _loc_16 = _loc_35 - m_upperTranslation;
                    _loc_18 = true;
                }
            }
            ...
            if (_loc_18)
            {
                ...
                m_K.col1.y = _loc_14 * m_s1 + _loc_15 * m_s2;
                m_K.col1.z = _loc_14 * m_s1 * m_a1 + _loc_15 * m_s2 * m_a2;
                m_K.col2.x = m_K.col1.y;
                m_K.col2.y = _loc_14 + _loc_15;
                m_K.col2.z = _loc_14 * m_a1 + _loc_15 * m_a2;
                m_K.col3.x = m_K.col1.z;
                m_K.col3.y = m_K.col2.z;
                m_K.col3.z = _loc_12 + _loc_13 + _loc_14 * m_a1 * m_a1 + _loc_15 * m_a2 * m_a2;
                m_K.Solve33(_loc_28, -_loc_29, -_loc_30, -_loc_19);
            }
            else
            {
                _loc_12 = m_invMassA;
                ...
                _loc_14 = m_invIA;
                _loc_15 = m_invIB;
                _loc_36 = _loc_12 + _loc_13 + _loc_14 * m_s1 * m_s1 + _loc_15 * m_s2 * m_s2;
                _loc_37 = _loc_14 * m_s1 + _loc_15 * m_s2;
                _loc_38 = _loc_14 + _loc_15;
                m_K.col1.Set(_loc_36, _loc_37, 0);
                m_K.col2.Set(_loc_37, _loc_38, 0);
                _loc_39 = m_K.Solve22(new b2Vec2(), -_loc_29, -_loc_30);
                _loc_28.x = _loc_39.x;
                _loc_28.y = _loc_39.y;
                _loc_28.z = 0;
            }
            var _loc_31:* = _loc_28.x * m_perp.x + _loc_28.z * m_axis.x;
            var _loc_32:* = _loc_28.x * m_perp.y + _loc_28.z * m_axis.y;
            var _loc_33:* = _loc_28.x * m_s1 + _loc_28.y + _loc_28.z * m_a1;
            var _loc_34:* = _loc_28.x * m_s2 + _loc_28.y + _loc_28.z * m_a2;
            _loc_6.x = _loc_6.x - m_invMassA * _loc_31;
            _loc_6.y = _loc_6.y - m_invMassA * _loc_32;
            _loc_7 = _loc_7 - m_invIA * _loc_33;
            _loc_8.x = _loc_8.x + m_invMassB * _loc_31;
            _loc_8.y = _loc_8.y + m_invMassB * _loc_32;
            _loc_9 = _loc_9 + m_invIB * _loc_34;
        ...
        override function InitVelocityConstraints(param1:b2TimeStep) : void
        {
            ...
            m_K.col1.y = _loc_16 * m_s1 + _loc_17 * m_s2;
            m_K.col1.z = _loc_16 * m_s1 * m_a1 + _loc_17 * m_s2 * m_a2;
            m_K.col2.x = m_K.col1.y;
            m_K.col2.y = _loc_16 + _loc_17;
            m_K.col2.z = _loc_16 * m_a1 + _loc_17 * m_a2;
            m_K.col3.x = m_K.col1.z;
            m_K.col3.y = m_K.col2.z;
            m_K.col3.z = _loc_14 + _loc_15 + _loc_16 * m_a1 * m_a1 + _loc_17 * m_a2 * m_a2;
            if (m_enableLimit)
            {
            ...
            if (param1.warmStarting)
            {
                ...
                _loc_19 = m_impulse.x * m_perp.x + (m_motorImpulse + m_impulse.z) * m_axis.x;
                _loc_20 = m_impulse.x * m_perp.y + (m_motorImpulse + m_impulse.z) * m_axis.y;
                _loc_21 = m_impulse.x * m_s1 + m_impulse.y + (m_motorImpulse + m_impulse.z) * m_a1;
                _loc_22 = m_impulse.x * m_s2 + m_impulse.y + (m_motorImpulse + m_impulse.z) * m_a2;
